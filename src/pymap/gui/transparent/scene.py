"""Module for a QGraphicsScene that can display a transparent background."""
...
class QGraphicsSceneWithTransparentBackground(QGraphicsScene):
    """A QGraphicsScene that can display a transparent background."""
    ...
    def add_transparent_background(
        ...
        """Set the transparent background group.
