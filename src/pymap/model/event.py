...
signpost_item_type = agb.types.BitfieldType(
    'u32', [('item', None, 16), ('flag', None, 8), ('amount', None, 8)]
)


def signpost_get_type(
...
person_array_type = agb.types.VariableSizeArrayType('event.person', (1, ['person_cnt']))

warp_array_type = agb.types.VariableSizeArrayType('event.warp', (1, ['warp_cnt']))

trigger_array_type = agb.types.VariableSizeArrayType(
    'event.trigger', (1, ['trigger_cnt'])
)

signpost_array_type = agb.types.VariableSizeArrayType(
    'event.signpost', (1, ['signpost_cnt'])
)
